在我们之前的文章中，我们彻底了解了[***REST 服务***](https://www.toolsqa.com/rest-assured/what-is-rest/)以及将我们与行业标准绑定在一起的一组约束。此外，我们可以在我们的软件应用程序中使用特定的架构元素，以获得具有最佳性能的理想结果。这些 REST 架构元素构成了 Restful 服务的关键概念元素。下图显示了关键架构元素以及 REST 架构中的约束 -
