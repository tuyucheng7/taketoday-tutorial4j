package cn.tuyucheng.taketoday.jersey.server.rest;
...
import cn.tuyucheng.taketoday.jersey.server.providers.FruitExceptionMapper;
...
public class FruitResourceIntegrationTest extends JerseyTest {
	...
	public void givenCreateFruit_whenFormContainsNullParam_thenResponseCodeIsBadRequest() {
		...
		assertEquals(400, response.getStatus(), "Http Response should be 400 ");
	...
	public void givenCreateFruit_whenJsonIsCorrect_thenResponseCodeIsCreated() {
		...
		assertEquals(Response.Status.CREATED.getStatusCode(), response.getStatus(), "Http Response should be 201 ");
	...
	public void givenFruitExists_whenSearching_thenResponseContainsFruit() {
		...
		assertEquals(204, response.getStatus(), "Http Response should be 204 ");
