...
public class User {
	...
	public boolean equals(Object o) {
		...
		if (o.getClass() == cn.tuyucheng.taketoday.performancetests.model.source.User.class) {
			cn.tuyucheng.taketoday.performancetests.model.source.User user =
				(cn.tuyucheng.taketoday.performancetests.model.source.User) o;
	...
	public AccountStatus conversion(cn.tuyucheng.taketoday.performancetests.model.source.AccountStatus status) {
