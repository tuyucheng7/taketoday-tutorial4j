...
public class Review {
	...
	int pricingGrade;
	int serviceGrade;
	cn.tuyucheng.taketoday.performancetests.model.source.User reviewingUser;
	String note;
	...
	public cn.tuyucheng.taketoday.performancetests.model.source.User getReviewingUser() {
		return reviewingUser;
	}

	public void setReviewingUser(cn.tuyucheng.taketoday.performancetests.model.source.User reviewingUser) {
