package cn.tuyucheng.taketoday.spring.cloud.archaius.extraconfigs;
...
class ArchaiusExtraConfigsLiveTest {
	...
	private static Map<String, String> createExpectedArchaiusProperties() {
		...
		map.put("tuyucheng.archaius.properties.three", "three FROM:extra.properties");
		map.put("tuyucheng.archaius.properties.four", "four FROM:other.properties");
		return map;
	}
