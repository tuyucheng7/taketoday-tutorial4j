...
class ArchaiusZookeeperLiveTest {
	...
	private static Map<String, String> createExpectedArchaiusProperties() {
		...
		map.put("tuyucheng.archaius.properties.one", "one FROM:zookeeper");
		map.put("tuyucheng.archaius.properties.two", "two FROM:application.properties");
		map.put("tuyucheng.archaius.properties.three", "three FROM:zookeeper");
		return map;
	}
