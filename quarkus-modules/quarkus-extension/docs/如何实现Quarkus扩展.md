...
### 5.3. 将 Liquibase API 公开为 CDI Bean
...
最后，我们创建一个BeanContainerListenerBuildItem以便在 Quarkus BeanContainer 启动后触发BeanContainerListener 。在这里，在侦听器中，我们将配置传递给 Liquibase bean。
