...
public class CustomerUnitTest extends LocaleAwareUnitTest {
	...
	public void whenAllInvalid_thenViolationsShouldBeReported() {
		...
		assertThat(violations).anyMatch(havingPropertyPath("customerTypeString").and(havingMessage("must be any of enum class cn.tuyucheng.taketoday.javaxval.enums.demo.CustomerType")));
