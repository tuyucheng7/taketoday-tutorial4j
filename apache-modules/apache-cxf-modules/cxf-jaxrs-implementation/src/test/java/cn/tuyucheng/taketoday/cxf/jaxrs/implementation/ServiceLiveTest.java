package cn.tuyucheng.taketoday.cxf.jaxrs.implementation;
...
class ServiceLiveTest {
	private static final String BASE_URL = "http://localhost:8080/tuyucheng/courses/";
	...
	@Test
	void whenUpdateNonExistentCourse_thenReceiveNotFoundResponse() throws IOException {
	...
	@Test
	void whenUpdateUnchangedCourse_thenReceiveNotModifiedResponse() throws IOException {
	...
	@Test
	void whenUpdateValidCourse_thenReceiveOKResponse() throws IOException {
	...
	@Test
	void whenCreateConflictStudent_thenReceiveConflictResponse() throws IOException {
	...
	@Test
	void whenCreateValidStudent_thenReceiveOKResponse() throws IOException {
	...
	@Test
	void whenDeleteInvalidStudent_thenReceiveNotFoundResponse() throws IOException {
	...
	@Test
	void whenDeleteValidStudent_thenReceiveOKResponse() throws IOException {
