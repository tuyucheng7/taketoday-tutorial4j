...
class SettingSameProcessEnvironmentVariableUnitTest {
   ...
   void givenReflexiveAccess_whenGetSourceMap_thenSuccessfullyModifyVariables(String environmentVariable, String value) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
   ...
   @Test
   @EnabledIfEnvironmentVariable(named = "PATH", matches = ".*", disabledReason = "The test relies on the presence of PATH variable")
   ...
   private static Map<String, String> getModifiableEnvironment() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
