package cn.tuyucheng.taketoday.arraycopy;

import cn.tuyucheng.taketoday.arraycopy.model.Address;
import cn.tuyucheng.taketoday.arraycopy.model.Employee;
...
public class ArrayCopyUtilUnitTest {
    ...
    public void givenArrayOfPrimitiveType_whenCopiedSubSequenceViaSystemsArrayCopy_thenSuccessful() {
        ...
        assertEquals(copiedArray[0], array[2]);
        assertEquals(copiedArray[1], array[3]);
        assertEquals(copiedArray[2], array[4]);
    }
    ...
    public void givenArrayOfPrimitiveType_whenCopiedSubSequenceViaArraysCopyOfRange_thenSuccessful() {
        ...
        assertEquals(3, copiedArray.length);
        assertEquals(copiedArray[0], array[1]);
        assertEquals(copiedArray[1], array[2]);
        assertEquals(copiedArray[2], array[3]);
    }
    ...
    public void givenArrayOfNonPrimitiveType_whenCopiedViaArraysCopyOf_thenDoShallowCopy() {
        ...
        assertEquals(copiedArray[0].getName(), employees[0].getName());
    }
    ...
    public void givenArraysOfSerializableNonPrimitiveType_whenCopiedViaSerializationUtils_thenDoDeepCopy() {
        ...
        Assert.assertNotEquals(copiedArray[0].getName(), employees[0].getName());
    }
