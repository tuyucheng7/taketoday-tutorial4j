package cn.tuyucheng.taketoday.array.operations;
...
class ArrayOperationsUnitTest {
    ...
    @Test
    void whenGetFirstObjectCalled_thenReturnFirstItemOfArray() {
    ...
    @Test
    void whenGetFirstIntCalled_thenReturnFirstItemOfArray() {
    ...
    @Test
    void whenGetLastObjectCalled_thenReturnLastItemOfArray() {
    ...
    @Test
    void whenGetLastIntCalled_thenReturnLastItemOfArray() {
    ...
    @Test
    void whenAppendObject_thenReturnArrayWithExtraItem() {
    ...
    @Test
    void whenAppendInt_thenReturnArrayWithExtraItem() {
    ...
    @Test
    void whenCompareObjectArrays_thenReturnBoolean() {
    ...
    @Test
    void whenCompareIntArrays_thenReturnBoolean() {
        int[] array2 = {8, 7, 6};
    ...
    // Deep compare
    @Test
    void whenDeepCompareObjectArrays_thenReturnBoolean() {
    ...
    @Test
    void whenDeepCompareIntArrays_thenReturnBoolean() {
        int[][] sameArray = {{1, 3}, {5}, {}};
        int[][] array2 = {{1, 3}, {5}, {3}};
    ...
    // Empty Check
    @Test
    void whenIsEmptyObjectArray_thenReturnBoolean() {
        Integer[] array2 = {};
        Integer[] array3 = null;
    ...
    @Test
    void whenIsEmptyIntArray_thenReturnBoolean() {
        int[] array2 = {};
    ...
    // Remove Duplicates
    @Test
    void whenRemoveDuplicateObjectArray_thenReturnArrayWithNoDuplicates() {
    ...
    @Test
    void whenRemoveDuplicateIntArray_thenReturnArrayWithNoDuplicates() {
    ...
    @Test
    void whenRemoveDuplicatePreservingOrderObjectArray_thenReturnArrayWithNoDuplicates() {
    ...
    @Test
    void whenRemoveDuplicatePreservingOrderIntArray_thenReturnArrayWithNoDuplicates() {
    ...
    // Print
    @Test
    void whenPrintObjectArray_thenReturnString() {
    ...
    @Test
    void whenPrintIntArray_thenReturnString() {
    ...
    // Box and unbox
    @Test
    void whenUnboxObjectArray_thenReturnPrimitiveArray() {
    ...
    @Test
    void henBoxPrimitiveArray_thenReturnObjectArray() {
    ...
    // Map values
    @Test
    void whenMapMultiplyingObjectArray_thenReturnMultipliedArray() {
    ...
    @Test
    void whenMapDividingObjectArray_thenReturnDividedArray() {
    ...
    @Test
    void whenMapIntArrayToString_thenReturnArray() {
    ...
    // Filter values
    @Test
    void whenFilterObjectArray_thenReturnFilteredArray() {
    ...
    @Test
    void whenFilterIntArray_thenReturnFilteredArray() {
    ...
    // Insert between
    @Test
    void whenInsertBetweenIntArrayToString_thenReturnNewArray() {
    ...
    @Test
    void whenInsertBetweenObjectArrayToString_thenReturnNewArray() {
    ...
    // Shuffle between
    @Test
    void whenShufflingIntArraySeveralTimes_thenAtLeastOneWithDifferentOrder() {
    ...
    @Test
    void whenShufflingObjectArraySeveralTimes_thenAtLeastOneWithDifferentOrder() {
    ...
    // Get random item
    @Test
    void whenGetRandomFromIntArrayToString_thenReturnItemContainedInArray() {
    ...
    @Test
    void whenGetRandomFromObjectArrayToString_thenReturnItemContainedInArray() {
    ...
    @Test
    void givenSourceArrayAndElement_whenAddElementUsingPureJavaIsInvoked_thenNewElementMustBeAdded() {
