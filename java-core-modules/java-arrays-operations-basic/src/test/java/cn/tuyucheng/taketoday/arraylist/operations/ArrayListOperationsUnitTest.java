package cn.tuyucheng.taketoday.arraylist.operations;
...
class ArrayListOperationsUnitTest {
    ...
    @Test
    void whenGetAnIntegerElementCalled_thenReturnTheIntegerElement() {
    ...
    @Test
    void whenModifyAnIntegerElementCalled_thenModifyTheIntegerElement() {
    ...
    @Test
    void whenAppendAnIntegerElementCalled_thenTheIntegerElementIsAppendedToArrayList() {
    ...
    @Test
    void whenInsertAnIntegerAtIndexCalled_thenTheIntegerElementIsInseredToArrayList() {
