package cn.tuyucheng.taketoday.deserializationfilters.utils;
...
public class FilterUtils {
   ...
   private static final String POJO_PACKAGE = "cn.tuyucheng.taketoday.deserializationfilters.pojo";
