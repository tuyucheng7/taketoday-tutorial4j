package cn.tuyucheng.taketoday.stringapi;
...
public class StringUnitTest {
   ...
   public void whenFormat_thenCorrect() {
      ...
      assertEquals("Welcome to Tuyucheng!", formatted);
   }
   ...
   public void whenCallRegionMatches_thenCorrect() {
      assertTrue("welcome to tuyucheng".regionMatches(false, 11, "tuyucheng", 0, 8));
   }
   ...
   public void whenSplit_thenCorrect() {
      ...
      String[] array = new String[]{"Welcome", "to", "Tuyucheng"};
