...
public class FirstNonRepeatingCharacterUnitTest {
   ...
   public void testNonRepeatingCharacterBruteForce() {
      ...
      Assert.assertEquals(program.firstNonRepeatingCharBruteForce("tuyucheng"), Character.valueOf('b'));
   ...
   public void testNonRepeatingCharacterBruteForceNaive() {
      FirstNonRepeatingCharacter program = new FirstNonRepeatingCharacter();
      Assert.assertEquals(program.firstNonRepeatingCharBruteForceNaive("tuyucheng"), Character.valueOf('b'));
   ...
   public void testNonRepeatingCharacterWithMap() {
      FirstNonRepeatingCharacter program = new FirstNonRepeatingCharacter();
      Assert.assertEquals(program.firstNonRepeatingCharWithMap("tuyucheng"), Character.valueOf('b'));
   ...
   public void testNonRepeatingCharacterWithArray() {
      FirstNonRepeatingCharacter program = new FirstNonRepeatingCharacter();
      Assert.assertEquals(program.firstNonRepeatingCharWithArray("tuyucheng"), Character.valueOf('b'));
