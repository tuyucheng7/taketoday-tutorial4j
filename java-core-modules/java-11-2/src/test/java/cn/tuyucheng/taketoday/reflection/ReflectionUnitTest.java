...
public class ReflectionUnitTest {
	...
	public void givenClassName_whenCreatesObject_thenCorrect() throws ClassNotFoundException {
		final Class<?> clazz = Class.forName("cn.tuyucheng.taketoday.reflection.Goat");
	...
	public void givenClass_whenRecognisesModifiers_thenCorrect() throws ClassNotFoundException {
		final Class<?> goatClass = Class.forName("cn.tuyucheng.taketoday.reflection.Goat");
	...
	public void givenClassField_whenGetsType_thenCorrect() throws Exception {
		final Field field = Class.forName("cn.tuyucheng.taketoday.reflection.Bird").getDeclaredField("walks");
