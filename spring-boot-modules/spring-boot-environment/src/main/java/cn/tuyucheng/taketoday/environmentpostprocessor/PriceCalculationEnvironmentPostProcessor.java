...
public class PriceCalculationEnvironmentPostProcessor implements EnvironmentPostProcessor {
	...
	private static final String PREFIX = "cn.tuyucheng.taketoday.environmentpostprocessor.";
	...
	private boolean hasOurPriceProperties(PropertySource<?> system) {
		return system.containsProperty(CALCUATION_MODE) && system.containsProperty(GROSS_CALCULATION_TAX_RATE);
	}
}