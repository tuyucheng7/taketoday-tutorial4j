...
class MetricsIntegrationTest {
	...
	@Test
	void whenMarkMeter_thenCorrectRates() throws InterruptedException {
	...
	@Test
	void whenInitRatioGauge_thenCorrectRatio() {
	...
	@Test
	void whenUseCacheGauge_thenCorrectGauge() {
	...
	@Test
	void whenUseDerivativeGauge_thenCorrectGaugeFromBase() {
		Gauge<List<Long>> activeUsersGauge = new ActiveUsersGauge(15, TimeUnit.MINUTES);
	...
	@Test
	void whenIncDecCounter_thenCorrectCount() {
	...
	@Test
	void whenUpdateHistogram_thenCorrectDistributionData() {
	...
	@Test
	void whenUseTimer_thenCorrectTimerContexts() throws InterruptedException {
