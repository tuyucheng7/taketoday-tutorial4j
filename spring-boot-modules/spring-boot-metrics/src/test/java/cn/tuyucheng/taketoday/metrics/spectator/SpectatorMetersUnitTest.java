...
class SpectatorMetersUnitTest {

	@Test
	void spectatorCounterTest() {
	...
	@Test
	void spectatorTimerTest() throws Exception {
	...
	@Test
	void spectatorLongTaskTimerTest() throws Exception {
		class MyRequestProcessor {
	...
	@Test
	void spectatorGauges_polledMeter_Test() {
		class MyList {
	...
	@Test
	void spectatorGauges_ActiveGauges_Test() {
		class MyList {
			private List<String> list = new ArrayList();
			private AtomicInteger listSize = new AtomicInteger(0);
			private Gauge gauge;
	...
	@Test
	void spectatorDistributionSummaryTest() throws Exception {
		class MyRequestProcessor {
