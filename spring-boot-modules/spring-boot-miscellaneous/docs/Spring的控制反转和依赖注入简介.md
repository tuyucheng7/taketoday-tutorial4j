...
@Configuration注解表示该类是 bean 定义的来源。我们也可以将它添加到多个配置类中。
...
有关@Autowired注解的更多信息，请参阅[Wiring In Spring](https://www.baeldung.com/spring-annotations-resource-inject-autowire)一文。
