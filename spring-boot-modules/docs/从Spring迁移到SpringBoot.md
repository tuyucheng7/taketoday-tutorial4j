...
默认情况下，@SpringBootApplication注解会扫描同一个包或以下包中的所有类。因此，一个方便的包结构可能如下所示：
...
要迁移，我们可以将所有资源文件移动到这些位置之一，或者我们可以通过设置 spring.resources.static -locations属性来自定义资源位置：
