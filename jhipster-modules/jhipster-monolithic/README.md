...
+ [JHipster简介](docs/JHipster简介.md)
+ [在JHipster中创建新角色和权限](docs/在JHipster中创建新角色和权限.md)
...
and can be run by starting Spring Boot in one terminal (`./mvnw spring-boot:run`) and running the tests (`gulp itest`)
in a second one.
