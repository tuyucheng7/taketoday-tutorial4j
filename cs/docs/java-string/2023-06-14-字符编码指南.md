...
许多ASCII扩展都取得了不同程度的成功，但显然，这对于更广泛的采用来说还不够好，因为许多字符仍然没有被表示出来。
...
让我们再次调用convertToBinary方法，输入为“语言”，编码为“UTF-8”：
...
对于第三个测试，我们使用CodingErrorAction.REPORT导致抛出MalformedInputException：
