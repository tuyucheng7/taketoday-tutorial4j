...
Java[加密体系结构(JCA)](https://docs.oracle.com/javase/9/security/java-cryptography-architecture-jca-reference-guide.htm)提供了一个框架来访问和实现Java中的加密功能，包括：
...
很简单，它表明我们将JndiLoginModule用作必需的LoginModule。
