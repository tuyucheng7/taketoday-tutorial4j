...
class RestTemplateBasicLiveTest {
    ...
    @Test
    void givenResourceUrl_whenSendGetForRequestEntity_thenStatusOk() throws IOException {
    ...
    @Test
    void givenResourceUrl_whenSendGetForRequestEntity_thenBodyCorrect() throws IOException {
    ...
    @Test
    void givenResourceUrl_whenRetrievingResource_thenCorrect() throws IOException {
    ...
    @Test
    void givenFooService_whenCallHeadForHeaders_thenReceiveAllHeadersForThatResource() {
    ...
    @Test
    void givenFooService_whenPostForObject_thenCreatedObjectIsReturned() {
    ...
    @Test
    void givenFooService_whenPostForLocation_thenCreatedLocationIsReturned() {
        final HttpEntity<Foo> request = new HttpEntity<>(new Foo("bar"));
    ...
    @Test
    void givenFooService_whenPostResource_thenResourceIsCreated() {
    ...
    @Test
    void givenFooService_whenPutExistingEntity_thenItIsUpdated() {
    ...
    @Test
    void givenFooService_whenPutExistingEntityWithCallback_thenItIsUpdated() {
        final HttpHeaders headers = prepareBasicAuthHeaders();
        final HttpEntity<Foo> request = new HttpEntity<>(new Foo("bar"), headers);
    ...
    @Test
    void givenFooService_whenPatchExistingEntity_thenItIsUpdated() {
        final HttpHeaders headers = prepareBasicAuthHeaders();
        final HttpEntity<Foo> request = new HttpEntity<>(new Foo("bar"), headers);
    ...
    @Test
    void givenFooService_whenCallDelete_thenEntityIsRemoved() {
    ...
    @Test
    void givenFooService_whenFormSubmit_thenResourceIsCreated() {
