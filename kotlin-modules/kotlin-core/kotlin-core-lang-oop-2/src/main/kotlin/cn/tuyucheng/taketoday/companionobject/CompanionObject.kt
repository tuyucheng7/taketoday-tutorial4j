package cn.tuyucheng.taketoday.companionobject
...
fun main() {
    val firstFactory: CompanionObject.AbstractFactory.FactoryCreator =
        CompanionObject.AbstractFactory.FirstRelatedClass
    println(firstFactory.produce().someFunction())

    val secondFactory: CompanionObject.AbstractFactory.FactoryCreator =
        CompanionObject.AbstractFactory.SecondRelatedClass
