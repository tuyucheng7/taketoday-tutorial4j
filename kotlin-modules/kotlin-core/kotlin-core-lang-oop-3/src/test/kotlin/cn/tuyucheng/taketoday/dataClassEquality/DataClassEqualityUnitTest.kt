package cn.tuyucheng.taketoday.dataClassEquality
...
data class TuyuchengString(val value: String, val chars: CharArray)
...
class DataClassEqualityUnitTest {
	...
	@Test
	fun `given two TuyuchengString objects with the same values in the array when compare with equals should get false`() {
	...
	@Test
	fun `given two TuyuchengStringV2 objects with the same values in the array when compare with equals should get true`() {
