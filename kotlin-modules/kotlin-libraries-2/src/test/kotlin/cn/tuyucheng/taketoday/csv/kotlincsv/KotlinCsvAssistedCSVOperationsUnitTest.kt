...
internal class KotlinCsvAssistedCSVOperationsUnitTest {
	...
	fun when_relaxed_file_is_read_then_everything_fails(): Unit = assertThrows<CSVFieldNumDifferentException> {
		val goods =
			cn.tuyucheng.taketoday.csv.kotlincsv.readRelaxedCsv(javaClass.getResourceAsStream("../apache/taxables.csv")!!)
	}.let { }

	@Test
	fun when_file_is_read_then_domain_objects_are_populated() {
		val goods = cn.tuyucheng.taketoday.csv.kotlincsv.readStrictCsv(javaClass.getResourceAsStream("taxables.csv")!!)
